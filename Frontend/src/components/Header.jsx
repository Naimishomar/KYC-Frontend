  ...
  return (
    ...
    <div className='w-full h-18 bg-black/80 px-10 flex items-center justify-between text-white'>
        <div className='flex items-center gap-6'>
            ...
            <div className='border rounded-4xl px-2 flex items-center justify-between w-100'>
        ...
        <div className='flex gap-6'>
          <button className='border px-8 py-2 rounded-4xl bg-white/15 cursor-pointer hover:bg-white/10'>Home</button>
          <button className='border px-8 py-2 rounded-4xl bg-white/15 cursor-pointer hover:bg-white/10'>Program</button>
          <button className='border px-8 py-2 rounded-4xl bg-[#06FA6F] text-black flex gap-2 items-center cursor-pointer'>Become Mentor<i className="ri-graduation-cap-line text-xl"></i></button>
        </div>
    </div>
