...
function Header() {
  ...
  return (
    <>
      {/* Top Header */}
      <div className='w-full bg-black/80 px-4 sm:px-10 py-4 flex items-center justify-between text-white'>
        <div className='flex items-center gap-4 sm:gap-6'>
          ...
          <div className='hidden md:flex border rounded-full px-2 items-center w-64 lg:w-72'>
            <input type="text" placeholder='Search courses' className='px-2 py-1 bg-transparent text-white focus:outline-none w-full' />
        ...
        <div className='hidden lg:flex gap-2'>
          <button className='border px-6 py-1 rounded-full bg-white/15 hover:bg-white/10'>Home</button>
          <button className='border px-6 py-1 rounded-full bg-white/15 hover:bg-white/10'>Program</button>
      ...
      {/* Submenu bar */}
      <div className='hidden lg:flex items-center justify-between px-4 sm:px-10 py-2 w-full bg-black/80'>
        <div className='flex gap-4'>
          <button className='text-white px-4 py-1 rounded-full bg-white/15 hover:bg-white/10'>College Events</button>
          <button className='text-white px-4 py-1 rounded-full bg-white/15 hover:bg-white/10'>College Compare</button>
          <button className='text-white px-4 py-1 rounded-full bg-white/15 hover:bg-white/10'>College Predictors</button>
        </div>
        <div>
