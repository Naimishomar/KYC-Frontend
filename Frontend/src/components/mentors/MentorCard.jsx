...
function MentorCard() {
  return (
    <div className='min-h-screen bg-[#E9E9E9] flex flex-wrap w-full justify-center px-15 py-3 space-x-4'>
      {mentors.map((item)=>(
      <div className='w-65 h-95 bg-red-400 group relative rounded-md overflow-hidden m-3'>
          ...
          <div className='bg-white w-full absolute bottom-0 h-35 p-5 transition-all duration-500 group-hover:h-full group-hover:bg-white/80 group-hover:pt-10'>
            ...
            <p className='text-sm mt-5'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime hic unde ipsum? Aliquid voluptatibus consectetur excepturi voluptates natus quas magni aut enim vitae. Ullam labore similique, deleniti laudantium atque, perferendis earum molestiae, qui voluptatibus.</p>
            <div className='flex justify-between'>
